...
import { AtividadeDiv, FrenteDiv, ImageDiv, WhatsappButton, RedeDiv, HistoriaDiv, BrownButton } from "./styles";
  ...
  return (
    <div>
      ...
      <div style={{display: "flex", flexDirection: "column", alignItems: "center", justifyContent: "center", marginTop: "-40px"}}>
        ...
        <ImageDiv>
          <FrenteDiv>
              <div style={{width: "80%", margin: "0 auto"}}>
                <S.BigText style={{fontSize: "50px", marginBottom: "25px", width: "500px"}}>PARTICIPE DE NOSSAS MISSAS</S.BigText>
        ...
        <S.BigText style={{ fontSize: "50px", marginTop: "25px"}}>NAS MÍDIAS SOCIAIS</S.BigText>
        <RedeDiv>
        ...
        <div style={{display: "flex", alignItems: "center"}}>
          <img style={{width: "490px", height: "734px", margin: "100px"}} src="assets/ns_perpetuo_historia.jpg" alt="Nossa senhora do Perpétuo Socorro História" />
          <HistoriaDiv>
            <S.BigText style={{fontSize: "50px", width: "450px"}}>NOSSA SENHORA DO PERPÉTUO SOCORRO</S.BigText>
            <S.DefaultText style={{ width: "450px"}}>O <span>quadro de Nossa Senhora do Perpétuo Socorro</span> constitui uma <span>pintura bizantina</span>, uma das <span>“Virgens da Paixão”</span>, que destacam o <span>significado da Paixão de Jesus e da intercessão da Mãe de Deus</span> em favor da humanidade.</S.DefaultText>
            <BrownButton type="button">SAIBA MAIS DA HISTÓRIA</BrownButton>
          </HistoriaDiv>
        </div>
      </div>
    </div>
