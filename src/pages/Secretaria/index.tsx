...
import { Container, ContatoContainer, ContatoImage, DefaultText, SmallText } from "../Contato/styles";
import { WhatsappButton } from "../Home/styles";

const Secretaria = () => (
    <Container>
        <S.BigText style={{textAlign: "center"}}>Secretaria</S.BigText>
        <ContatoContainer>
                ...
                <div>
                    ...
                    <DefaultText style={{fontWeight: "bold", marginBottom: "40px"}}>CEP: 09725-610</DefaultText>
                </div>
        </ContatoContainer>
    </Container>
);
