  ...
  return (
    <div style={{ margin: "50px 100px" }}>
      ...
      <div>
        ...
        <S.BigText>Como rezá-lo?</S.BigText>
        <S.SmallText>
          Num ritmo compassado de orações “simples e profundas”, como as de uma
          criança à sua mãe. O Santo Rosário está dividido em elementos, partes,
          seções e o todo. Por outras palavras, é perfeitamente pensado com o
          propósito de ter uma melhor intimidade, familiaridade, de forma
          natural e sobrenatural com Jesus através de Maria, a mãe que dá à luz
          os novos filhos de Deus.
        </S.SmallText>
        <S.SmallText>
          Para uma melhor contemplação da vida de Cristo, o Santo Rosário está
        ...
        <S.SmallText>
          ...
          inimigos. Em nome do Pai, e do Filho e do Espírito Santo. Amém”
        </S.SmallText>
        ...
        <S.SmallText>
          ...
          separada, reze um Pai-Nosso. Em seguida, três Ave-Marias e, na conta
          maior separada, um “Glória”:
        </S.SmallText>
        <S.SmallText>
        ...
        <S.SmallText>
          “Glória ao Pai, ao Filho e o Espírito Santo. Como era no princípio,
          agora é sempre. Amém.”
        </S.SmallText>
        <S.SmallText>
          “Oh! Meu Jesus, perdoai-nos, livrai-nos do fogo do inferno, levai as
        ...
        <S.SmallText>
          ...
          lembramos de um mistério da vida de Jesus, seguido de 1 Pai-Nosso e 10
        ...
        <S.SmallText>
          Após cada dezena de Ave-Marias, deve-se rezar um “Glória” e a oração
          pelas almas do Purgatório:
        </S.SmallText>
        <S.SmallText>
          “Ó meu Jesus, perdoai-nos, livrai-nos do fogo do inferno, levai as
          almas todas para o Céu, principalmente as que mais precisarem de Vossa
          Misericórdia.”
        </S.SmallText>
        ...
        <S.SmallText>
          ...
          ó piedosa, ó doce sempre Virgem Maria. Rogai por nós, santa Mãe de
          Deus. Para que sejamos dignos das promessas de Cristo.”
        </S.SmallText>
        <S.BigText>Terço ou Rosário?</S.BigText>
        <S.SmallText>
          Costumamos designar “terço” como a récita das 150 Ave-Marias,
          acompanhadas do mistério do dia. É possível, também, recitar todos os
          4 grupos de mistérios em sequência. A isso designamos “Rosário”.
          Iniciamos meditando o nascimento de Jesus, com os mistérios gozosos, e
          terminamos com sua ressurreição e instituição sacramental da
          Eucaristia, com os mistérios gloriosos. Dependendo do tempo disponível
          do fiel, ele escolhe quanto deseja rezar.
        </S.SmallText>
        <S.SmallText>
          Com a oração completa do Rosário, podemos meditar sobre a vida inteira
          de Jesus e, com Ele, entregar também nossas vidas. Por isso, essa é
          uma prática muito difundida e que garante muitos frutos às almas.
        </S.SmallText>
        <S.BigText>O Rosário e Nossa Senhora de Fátima</S.BigText>
        <S.SmallText>
        ...
        <S.SmallText>
          ...
          incessantemente, todos os dias, ao visitar a Cova da Íria e durante
          seus afazeres. Isso está registrado nas memórias da Irmã Lúcia,
          especialmente a São Francisco Marto:
        </S.SmallText>
        <S.SmallText>
          “– Ó minha Nossa Senhora, terços, rezo todos quantos Vós quiserdes. E,
          desde aí, tomou o costume de se afastar de nós, como que passeando; e
        ...
        <S.SmallText>
          ...
          coração humilde e disponível, que a encontre muitas vezes na oração do
          Santo Terço. Por isso, seu pedido é recorrente em cada aparição que
          realiza. Quando estudamos tais aparições, especialmente com o livro
          “Aparições de Nossa Senhora”, vemos o quanto a Virgem Maria deseja
          nossa presença amorosa por meio do rosário.
        </S.SmallText>
